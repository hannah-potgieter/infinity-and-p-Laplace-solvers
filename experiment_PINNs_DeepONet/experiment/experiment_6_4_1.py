...
Usage:
    python experiment/experiment_6_4_1.py --domain disc   --epochs 20
    python experiment/experiment_6_4_1.py --domain square --epochs 20
    python experiment/experiment_6_4_1.py --domain all    --epochs 20
"""
...
def run_experiment(domain, args):
    ...
    base = os.path.join(args.output_dir, 'expr_6_4_1', domain, run_tag)
    setup_logging(base)
    ...
    # ---- plots ---------------------------------------------------------
    plot_training_history(history, f'6.4.1 {domain}',
                          os.path.join(output_dirs['plots'], 'training.png'))
    plot_mse_vs_p(ev['p'], ev['mse'], f'6.4.1 {domain}',
...
def main():
    ...
    ap.add_argument('--data-dir', default='./data/distance_to_origin')
