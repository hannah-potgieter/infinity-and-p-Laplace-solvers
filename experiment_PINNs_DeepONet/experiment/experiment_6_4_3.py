#!/usr/bin/env python3
"""
Section 6.4.3 — Distance to Boundary, All Ellipses (DeepONet)
...
Usage:
    python experiment/experiment_6_4_3.py --epochs 20 --total-div 10
    python experiment/experiment_6_4_3.py --epochs 20 --total-div 2   # smaller dataset
"""
...
def run_experiment(args):
    ...
    base = os.path.join(args.output_dir, 'expr_6_4_3', tag, run_tag)
    setup_logging(base)
    ...
    plot_training_history(
        history, f'6.4.3 All Ellipses ({tag})',
        os.path.join(output_dirs['plots'], 'training.png'),
    )
    plot_mse_vs_p(
        ev['p'], ev['mse'], f'6.4.3 All Ellipses ({tag})',
...
def main():
    ...
    ap.add_argument('--data-dir', default='./data/ellipse_family')
