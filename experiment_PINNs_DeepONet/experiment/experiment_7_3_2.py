#!/usr/bin/env python3
"""
Experiment 6.3.2 — Distance to Boundary (DeepONet, 2-D & 3-D)
...
Usage:
    python experiment_6_3_2.py --domain disc     --epochs 20
    python experiment_6_3_2.py --domain sphere   --epochs 20
    python experiment_6_3_2.py --domain all-2d   --epochs 20
    python experiment_6_3_2.py --domain all-3d   --epochs 20
    python experiment_6_3_2.py --domain all      --epochs 20
"""
