"""
Plot MSE vs p from saved iterative p-Laplacian training histories (Experiment 7.2).

Reads from:  outputs/expr_7_2_iter/{stage}_{domain}/npy/training_history.npz
             outputs/expr_7_2_iter/{stage}_{domain}/train.log
Saves to:    outputs/images/

Usage:
    python plot/experiment_7_2_plot.py
    python plot/experiment_7_2_plot.py --domain square
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Plot MSE vs p for Experiment 7.2 iterative training',
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--domain', type=str, default='square',
                        choices=['square', 'disc'],
                        help='Domain name')
    parser.add_argument('--base-dir', type=str, default='outputs/expr_7_2_iter',
                        help='Base directory for experiment 7.2 iterative outputs')
