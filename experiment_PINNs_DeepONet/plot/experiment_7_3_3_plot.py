"""
Plot results for Experiment 7.3.3 (All Ellipses DeepONet).
...
Reads from:  outputs/expr_7_3_3/total{N}/{run_tag}/npy/mse.npz
Saves to:    outputs/images/

Usage:
    python plot/experiment_7_3_3_plot.py --total-div 10
    python plot/experiment_7_3_3_plot.py --total-div 8
    python plot/experiment_7_3_3_plot.py --total-div all
"""
...
def plot_mse_vs_theta(theta, mse_theta, total_div, out_path, p_label='500'):
    ...
    ax.set_title(fr'MSE vs $\theta$ ($p={p_label}$)', fontsize=20)
...
def plot_mse_vs_ab(a_real, b_real, mse_ab, out_path, p_label='500'):
    ...
    ax.set_title(fr'MSE over varying $a$ and $b$ ($p={p_label}$)', fontsize=20)
    ax.tick_params(labelsize=14)
...
def plot_total_div(total_div, base_dir, run_tag, out_dir):
    ...
    print(f"Plotting 7.3.3 total_div={td}:")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Plot 7.3.3 All Ellipses (MSE vs θ, MSE vs (a,b))',
    ...
    parser.add_argument('--base-dir', type=str, default='outputs/expr_7_3_3',
                        help='Base directory for experiment 7.3.3 outputs')
