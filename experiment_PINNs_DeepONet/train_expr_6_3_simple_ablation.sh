...
# ── p = 100 ──
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag eta0                      --eta 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag clip0                     --clip-residual 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag gradclip0                 --clip-grad-norm 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag out0                      --outlier-percentile 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag clip0_gradclip0           --clip-residual 0 --clip-grad-norm 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag gradclip0_out0            --clip-grad-norm 0 --outlier-percentile 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag gradclip0_eta0            --clip-grad-norm 0 --eta 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag clip0_gradclip0_out0      --clip-residual 0 --clip-grad-norm 0 --outlier-percentile 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag clip0_gradclip0_eta0      --clip-residual 0 --clip-grad-norm 0 --eta 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag gradclip0_out0_eta0       --clip-grad-norm 0 --outlier-percentile 0 --eta 0
python experiment/experiment_6_3.py --mode simple --p 100 --domain square --save-npy --run-tag clip0_gradclip0_out0_eta0 --clip-residual 0 --clip-grad-norm 0 --outlier-percentile 0 --eta 0
